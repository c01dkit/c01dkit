...
- 🌐 Developing web apps catches me
- 🔠 Puzzle hunt lover
...
[Lyceum: Start from zero and learn the complete history of artificial intelligence through interactive classroom dialog](https://lyceum.edu.estate/)
...
[![My Skills](https://skillicons.dev/icons?i=c,py,php,bash,cmake,cloudflare,docker,linux,latex,mysql,flask,fastapi,firebase,git,astro,js,html,css,jquery,react,vue,vite,nginx)](https://skillicons.dev)
